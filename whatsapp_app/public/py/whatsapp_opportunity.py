...
def whatsapp_message_send_opportunity(doc, method):    
    if doc.reference_type == "Opportunity" and doc.status == "Open":        
        ...
        for user in user_details:                       
            ...
            field_value = frappe.db.sql(" select custom_opportunity_name, industry, contact_mobile,contact_email,custom_equipment_name,request_type  from `tabOpportunity` where name=%s",doc.reference_name)  

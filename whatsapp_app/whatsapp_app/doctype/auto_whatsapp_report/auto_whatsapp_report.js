...
frappe.ui.form.on("Auto Whatsapp Report", {
	refresh: function (frm) {
		...
		if (!frm.is_new()) {
			frm.add_custom_button(__("Download"), function () {
				var w = window.open(
					frappe.urllib.get_full_url(
						"/api/method/whatsapp_app.whatsapp_app.doctype.auto_whatsapp_report.auto_whatsapp_report.download?" +
							"name=" +
			...
			frm.add_custom_button(__("Send Now"), function () {
				frappe.call({
					method: "whatsapp_app.whatsapp_app.doctype.auto_whatsapp_report.auto_whatsapp_report.send_now",
			...
			if (!frm.doc.whatsapp_to) {
				frm.set_value("whatsapp_to", frappe.session.user);
			}
		}
	},
	report: function (frm) {
